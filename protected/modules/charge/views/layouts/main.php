...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo Yii::app()->params['host']; ?>/static/admin/css/common.css" />
            ...
            <div class="main-container-inner">
                ...
                <div class="sidebar" id="sidebar">
                    ...
                    <ul class="nav nav-list">
                        <li class="active">
                            <a href="<?php echo $this->createUrl('/charge') ?>">
                                <i class="icon-dashboard"></i>
                                <span class="menu-text"> 控制台 </span>
                            </a>
                        </li>
                        <li <?php if (in_array($controller_id, array('project'))): ?>class="active open"<?php endif; ?>>
                            ...
                            <ul class="submenu">
                                <li <?php if ($controller_id == 'project'): ?>class="active"<?php endif; ?>>
                                    <a <?php if ($controller_id == 'project'): ?>class="active"<?php endif; ?> href="<?php echo $this->createUrl('/charge/project') ?>">
