...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '1', 'ohs_4sgyk31vkfKLHy2wg5HrrGeo', '1481550408', '127.0.0.1', '1', '502', '', '1360085491');
...
-- Records of announce
-- ----------------------------
INSERT INTO `announce` VALUES ('2', '种植面积减少产量下降', '&#60;p&#62;&#60;span&#32;style&#61;&#34;color:&#32;rgb(34,&#32;34,&#32;34)&#59;&#32;font&#45;family:&#32;Menlo,&#32;monospace&#59;&#32;font&#45;size:&#32;12px&#59;&#32;white&#45;space:&#32;pre&#45;wrap&#59;&#32;background&#45;color:&#32;rgb(255,&#32;255,&#32;255)&#59;&#34;&#62;种植面积减少产量下降&#60;&#47;span&#62;&#60;&#47;p&#62;', '1481200349');
INSERT INTO `announce` VALUES ('3', '萝卜价格回暖 能坚持多久!', '&#60;p&#62;&#60;span&#32;style&#61;&#34;color:&#32;rgb(34,&#32;34,&#32;34)&#59;&#32;font&#45;family:&#32;Menlo,&#32;monospace&#59;&#32;font&#45;size:&#32;12px&#59;&#32;white&#45;space:&#32;pre&#45;wrap&#59;&#32;background&#45;color:&#32;rgb(255,&#32;255,&#32;255)&#59;&#34;&#62;萝卜价格回暖&#32;能坚持多久&#33;&#60;&#47;span&#62;&#60;&#47;p&#62;', '1481350709');
...
-- Records of charge
-- ----------------------------
INSERT INTO `charge` VALUES ('2', 'lzy', '3', '18922835259', '96e79218965eb72c92a549dd5a330112', '1481118418');
...
-- Records of depart
-- ----------------------------
INSERT INTO `depart` VALUES ('2', '部门1', '1481105845');
INSERT INTO `depart` VALUES ('3', '部门2', '1481105944');
INSERT INTO `depart` VALUES ('4', '部门3', '1481119334');
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('3', '娃娃菜', '26', '1481255380');
INSERT INTO `goods` VALUES ('4', '皇帝菜', '26', '1481263003');
INSERT INTO `goods` VALUES ('5', '西瓜', '28', '1481263009');
INSERT INTO `goods` VALUES ('6', '柚子', '29', '1481263017');
INSERT INTO `goods` VALUES ('7', '菠萝', '28', '1481263022');
INSERT INTO `goods` VALUES ('8', '111', '26', '1481553154');
INSERT INTO `goods` VALUES ('9', '2222', '28', '1481553170');
INSERT INTO `goods` VALUES ('10', '333', '29', '1481553183');
INSERT INTO `goods` VALUES ('11', '4444', '30', '1481553208');
INSERT INTO `goods` VALUES ('12', '555', '30', '1481553242');
INSERT INTO `goods` VALUES ('13', '666', '30', '1481553247');
...
-- ----------------------------
INSERT INTO `goods_category` VALUES ('25', '蔬菜类', '0', '蔬菜类', '500g/元', '1', '1481209450');
INSERT INTO `goods_category` VALUES ('26', '白菜', '25', '蔬菜类,白菜', '500g/元', '2', '1481209454');
INSERT INTO `goods_category` VALUES ('27', '水果类', '0', '水果类', '500g/元', '1', '1481211953');
INSERT INTO `goods_category` VALUES ('28', '多水分', '27', '水果类,多水分', '500g/元', '2', '1481212003');
INSERT INTO `goods_category` VALUES ('29', '少水分', '27', '水果类,少水分', '500g/元', '2', '1481212110');
INSERT INTO `goods_category` VALUES ('30', '热量高', '27', '水果类,热量高', '500g/元', '2', '1481262579');
INSERT INTO `goods_category` VALUES ('31', '动物', '0', '动物', '', '1', '1481380105');
...
CREATE TABLE `place` (
  ...
  `weight` float(8,2) DEFAULT NULL COMMENT '权重',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`),
...
-- Records of place
-- ----------------------------
INSERT INTO `place` VALUES ('4', '101', '秀英小街农贸市场', '0.10', '1481030557');
INSERT INTO `place` VALUES ('5', '101', '龙舌坡农贸市场', '0.10', '1481032850');
INSERT INTO `place` VALUES ('6', '101101101101', '沿江三西路农贸市场', '0.40', '1481034076');
INSERT INTO `place` VALUES ('7', '101101101101', '龙华城金农贸市场', '0.20', '1481034105');
INSERT INTO `place` VALUES ('8', '101101101', '府城东门市场', '0.20', '1481125122');
INSERT INTO `place` VALUES ('9', '101101101102', '福永海鲜市场', '0.30', '1481125134');
INSERT INTO `place` VALUES ('10', '101101', '11', null, '1481357781');
...
CREATE TABLE `price_log` (
  ...
  `project_dates` text COMMENT '项目日期段',
  `project_id` int(11) NOT NULL DEFAULT '0' COMMENT '项目ID',
  `goodscate_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品一级分类ID',
  `place_id` int(11) NOT NULL DEFAULT '0' COMMENT '采价点ID',
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品ID',
  `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '价格',
  `project_first` varchar(64) NOT NULL DEFAULT '' COMMENT '项目第一次采价时间',
  `project_second` varchar(64) NOT NULL DEFAULT '' COMMENT '项目第二次采价时间',
  `times` tinyint(1) NOT NULL DEFAULT '0' COMMENT '第几次报价',
  `user_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0是采价员，1是部门管理员，2是总管理员',
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '操作员ID',
  `reason` varchar(512) NOT NULL DEFAULT '' COMMENT '操作理由',
  `date` char(8) NOT NULL DEFAULT '' COMMENT '采价日期',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT '采价时间',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `price_log` VALUES ('1', '种植面积减少产量下降', 'ddfdf', null, '23', '25', '4', '3', '10.00', '8:30-18:00', '2:2-3:3', '1', '0', '2', '', '20161211', '1481385625');
INSERT INTO `price_log` VALUES ('2', '种植面积减少产量下降', 'ddfdf', null, '23', '25', '4', '3', '40.00', '8:30-18:00', '2:2-3:3', '1', '0', '2', '', '20161211', '1481387347');

-- ----------------------------
-- Table structure for `price_operate`
-- ----------------------------
DROP TABLE IF EXISTS `price_operate`;
CREATE TABLE `price_operate` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `depart_id` int(11) NOT NULL COMMENT '部门ID',
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品ID',
  `avg` decimal(10,2) NOT NULL COMMENT '平均价格',
  `date` char(8) NOT NULL DEFAULT '' COMMENT '日期',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1是数据上报，2是审核',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of price_operate
-- ----------------------------

-- ----------------------------
-- Table structure for `price_operate_log`
-- ----------------------------
DROP TABLE IF EXISTS `price_operate_log`;
CREATE TABLE `price_operate_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态，1是上报，2是审核,3后台管理员操作',
  `user_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1是部门管理员，2是总管理员',
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户ID',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT '操作时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of price_operate_log
-- ----------------------------
...
CREATE TABLE `project` (
  ...
  `dates` text COMMENT '日期段',
  `desc` text COMMENT '项目简介',
  `place_ids` varchar(64) NOT NULL DEFAULT '' COMMENT '采价点IDs',
  `goodscate_ids` varchar(64) NOT NULL DEFAULT '' COMMENT '商品分类ID集合',
...
-- Records of project
-- ----------------------------
INSERT INTO `project` VALUES ('23', '种植面积减少产量下降', '20161210,20161211,20161213', 'ddfdf', '4,5,8,6,9', '25,27,31', '8:30-18:00', '2:2-3:3', '2,3', '1481346110');
INSERT INTO `project` VALUES ('24', '萝卜价格回暖 能坚持多久!', '20161211,20161212,20161213,20161221,20161222', null, '', '25,27,31', '7:0-17:30', '', '3,4', '1481359581');
INSERT INTO `project` VALUES ('25', '种植面积减少产量下降2', null, null, '', '', '7:0-17:30', '', '2,3,4', '1481359600');
INSERT INTO `project` VALUES ('26', '萝卜价格回暖 能坚持多久!', null, null, '', '', '7:0-17:30', '20:00-23:00', '2,3,4', '1481359628');
INSERT INTO `project` VALUES ('27', '111', null, null, '', '25,31', '7:0-17:30', '', '2,4', '1481448874');

-- ----------------------------
-- Table structure for `project_date_relation`
-- ----------------------------
DROP TABLE IF EXISTS `project_date_relation`;
CREATE TABLE `project_date_relation` (
  `project_id` int(11) NOT NULL DEFAULT '0' COMMENT '项目ID',
  `date` char(8) NOT NULL DEFAULT '' COMMENT '项目日期',
  UNIQUE KEY `date_project_id` (`project_id`,`date`),
  KEY `project_id` (`project_id`),
  KEY `date` (`date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of project_date_relation
-- ----------------------------
INSERT INTO `project_date_relation` VALUES ('23', '20161210');
INSERT INTO `project_date_relation` VALUES ('23', '20161211');
INSERT INTO `project_date_relation` VALUES ('23', '20161213');
INSERT INTO `project_date_relation` VALUES ('24', '20161211');
INSERT INTO `project_date_relation` VALUES ('24', '20161212');
INSERT INTO `project_date_relation` VALUES ('24', '20161213');
INSERT INTO `project_date_relation` VALUES ('24', '20161221');
INSERT INTO `project_date_relation` VALUES ('24', '20161222');
...
-- ----------------------------
INSERT INTO `project_depart_relation` VALUES ('23', '2');
INSERT INTO `project_depart_relation` VALUES ('23', '3');
INSERT INTO `project_depart_relation` VALUES ('24', '3');
INSERT INTO `project_depart_relation` VALUES ('24', '4');
INSERT INTO `project_depart_relation` VALUES ('25', '2');
INSERT INTO `project_depart_relation` VALUES ('25', '3');
INSERT INTO `project_depart_relation` VALUES ('25', '4');
INSERT INTO `project_depart_relation` VALUES ('26', '2');
INSERT INTO `project_depart_relation` VALUES ('26', '3');
INSERT INTO `project_depart_relation` VALUES ('26', '4');
INSERT INTO `project_depart_relation` VALUES ('27', '2');
INSERT INTO `project_depart_relation` VALUES ('27', '4');

-- ----------------------------
-- Table structure for `project_goodscate_relation`
-- ----------------------------
DROP TABLE IF EXISTS `project_goodscate_relation`;
CREATE TABLE `project_goodscate_relation` (
  `project_id` int(11) NOT NULL COMMENT '项目ID',
  `goodscate_id` int(11) NOT NULL COMMENT '商品ID',
  UNIQUE KEY `project_goods_id` (`project_id`,`goodscate_id`) USING BTREE,
  KEY `project_id` (`project_id`),
  KEY `goods_id` (`goodscate_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of project_goodscate_relation
-- ----------------------------
INSERT INTO `project_goodscate_relation` VALUES ('23', '25');
INSERT INTO `project_goodscate_relation` VALUES ('23', '27');
INSERT INTO `project_goodscate_relation` VALUES ('23', '31');
INSERT INTO `project_goodscate_relation` VALUES ('24', '25');
INSERT INTO `project_goodscate_relation` VALUES ('24', '27');
INSERT INTO `project_goodscate_relation` VALUES ('24', '31');
INSERT INTO `project_goodscate_relation` VALUES ('27', '25');
INSERT INTO `project_goodscate_relation` VALUES ('27', '31');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('2', '刘某某', '1', '18922835259', '352201199202261613', '25f9e794323b453885f5181f1b624d0b', '20161210', '4,5,8,6,7', '3', '11111', '1111111111111111111', '1111', '1', '1481111861');
INSERT INTO `user` VALUES ('3', 'liuziyao', '1', '18922835258', '352201199202261613', '84067cf461e14345471db77b30bdc807', '20161209', '', '2', '1111111111111111111', '1111111111111111111', '11111', '1', '1481357534');
